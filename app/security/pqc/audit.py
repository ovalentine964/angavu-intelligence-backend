...
class CryptoAuditLogger:
    ...
    def __init__(self, audit_dir: str | None = None, max_file_size: int = 5 * 1024 * 1024):
    ...
    def log_signature(self, algorithm_id: str, data_hash: str, success: bool, error: str | None = None):
        self._log(
    ...
    def log_verification(self, algorithm_id: str, data_hash: str, valid: bool, error: str | None = None):
        self._log(
    ...
    def log_key_exchange(self, algorithm_id: str, is_hybrid: bool, success: bool, error: str | None = None):
        self._log(
