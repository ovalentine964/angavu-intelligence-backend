"""
Intelligence product models — canonical definitions.

Consolidates all intelligence-related ORM models into one module:
- IntelligenceProduct: Generic intelligence product (market demand, pricing, etc.)
- DataAccessLog: Audit trail for buyer data access (Kenya DPA 2019)
- SokoPulseReport: FMCG demand forecasting
- BiasharaPulseReport: Government MSME Activity Index
- AlamaScore: Bank credit scoring (300-850)
- AlamaScoreOutcome: Credit outcome tracking for calibration
- JamiiInsightsReport: NGO financial inclusion
- TaxBaseEstimation: Government revenue estimation
- DistributionGapReport: FMCG market coverage gaps
"""
...
# ═══════════════════════════════════════════════════════════════════════════════
# IntelligenceProduct — Generic Intelligence Product
# ═══════════════════════════════════════════════════════════════════════════════
...
class IntelligenceProduct(Base):
    ...
    Products are generated by the data pipeline and include:
    ...
    data = Column(JSON, nullable=False, doc="Intelligence payload as JSON")
    metadata_extra = Column(JSON, nullable=True)
    price_kes = Column(Float, nullable=True, default=0)
    users_included = Column(Integer, nullable=True)
    k_anonymity_value = Column(Integer, nullable=True)
    quality_score = Column(Float, nullable=True)
    status = Column(
...
# ═══════════════════════════════════════════════════════════════════════════════
# DataAccessLog — Buyer Data Access Audit Trail
# ═══════════════════════════════════════════════════════════════════════════════
...
class DataAccessLog(Base):
    ...
    Critical for regulatory compliance (Kenya Data Protection Act 2019).
    """
