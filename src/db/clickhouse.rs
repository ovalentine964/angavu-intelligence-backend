...
impl AnalyticsRepository {
    ...
    pub async fn get_revenue_by_period(
        ...
        let result = self.client.query(&query).fetch_all::<RevenueAggregation>().await?;
        Ok(result)
    }
    ...
    pub async fn get_customer_patterns(
        ...
        let result = self.client.query(&query).fetch_all::<CustomerPattern>().await?;
        Ok(result)
    }
    ...
    /// Get intelligence metrics over time
    pub async fn get_intelligence_metrics(
        ...
        let result = self.client.query(&query).fetch_all::<IntelligenceMetric>().await?;
        Ok(result)
    }
    ...
    pub async fn get_system_health(
        ...
        let result = self.client.query(&query).fetch_all::<SystemHealthMetric>().await?;
        Ok(result)
    }
