...
impl DistributionBridge {
    ...
    pub fn fit_distribution(&self, data: &[f64], distribution: &str) -> Result<DistributionFitResult, String> {
    ...
    pub fn mgf(&self, distribution: &str, t: f64, params: &std::collections::HashMap<String, f64>) -> Result<f64, String> {
        ...
        result.get("mgf_value")
            .and_then(|v| v.as_f64())
            .ok_or_else(|| "Missing mgf_value in response".to_string())
    }

    /// Demonstrate CLT via sampling distribution.
    pub fn clt_demo(&self, data: &[f64], sample_size: usize, n_samples: usize) -> Result<Value, String> {
    ...
    pub fn clt_ci(&self, data: &[f64], confidence: f64) -> Result<ConfidenceIntervalResult, String> {
    ...
    pub fn parametric_bootstrap(&self, data: &[f64], statistic: &str, distribution: &str, n_bootstrap: usize, confidence: f64) -> Result<Value, String> {
